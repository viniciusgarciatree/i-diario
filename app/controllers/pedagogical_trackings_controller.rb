class PedagogicalTrackingsController < ApplicationController
  ...
  def minimum_year
    return if current_user_school_year == 2021
  ...
  def build_percent_table(unity, start_date, end_date, school_days, classroom_id = nil, teacher_id = nil)
    ...
    frequency_percentage = frequency_percentage > 100 ? 100 : frequency_percentage
    content_record_percentage = content_record_percentage > 100 ? 100 : content_record_percentage
